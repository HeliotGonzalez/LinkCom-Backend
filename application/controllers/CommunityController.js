...
router.get('/:communityID/joinRequests', async (req, res) => handleError(HTTPMethodsMap.GET, res, await serviceFactory.get('communities').joinRequests(buildCriteriaFrom({...req.params, ...req.query}))));
